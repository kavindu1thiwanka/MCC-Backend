...
public class ReportServiceImpl implements ReportService {
    ...
    private byte[] generateReservationsPdf(List<ReservationDto> reservations, ReportDto reportData) {
        try (PDDocument document = new PDDocument();
            ...
            addMetadata(contentStream, reportData.getStartDate(), reportData.getEndDate());
    ...
    private void addMetadata(PDPageContentStream contentStream, Date startDate, Date endDate) throws IOException {
        ...
        float textYPos = 750;
        contentStream.beginText();
        contentStream.newLineAtOffset(900, textYPos);
