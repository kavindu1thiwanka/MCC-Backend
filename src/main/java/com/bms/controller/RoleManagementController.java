...
public class RoleManagementController {
    ...
    public ResponseEntity<Object> getRoleWisePrivilegeList(@RequestParam Integer roleId) throws BMSCheckedException {
        return roleManagementService.getRoleWisePrivilegeList(roleId);
    }

    @PutMapping(ACTIVATE_ROLE_V1)
    public ResponseEntity<Object> activateRole(@RequestParam Integer roleId) throws BMSCheckedException {
        return roleManagementService.activateRole(roleId);
    }

    @PutMapping(ACTIVATE_ROLE_BULK_V1)
    public ResponseEntity<Object> activateRoleBulk(@RequestBody List<Integer> roleIdList) throws BMSCheckedException {
        return roleManagementService.activateRoleBulk(roleIdList);
    }

    @PutMapping(INACTIVATE_ROLE_V1)
    public ResponseEntity<Object> inactivateRole(@RequestParam Integer roleId) throws BMSCheckedException {
        return roleManagementService.inactivateRole(roleId);
    }

    @PutMapping(INACTIVATE_ROLE_BULK_V1)
    public ResponseEntity<Object> inactivateRoleBulk(@RequestBody List<Integer> roleIdList) throws BMSCheckedException {
        return roleManagementService.inactivateRoleBulk(roleIdList);
    }

    @PutMapping(DELETE_ROLE_V1)
    public ResponseEntity<Object> deleteRole(@RequestParam Integer roleId) throws BMSCheckedException {
        return roleManagementService.deleteRole(roleId);
    }

    @PutMapping(DELETE_ROLE_BULK_V1)
    public ResponseEntity<Object> deleteRoleBulk(@RequestBody List<Integer> roleIdList) throws BMSCheckedException {
